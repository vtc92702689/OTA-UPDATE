...
bool indexHtmlCreated = false; // Cờ để kiểm tra trạng thái tạo file index.html
String resultCreateHtml;
...
<body>
    ...
    if (!file) {
        ...
        resultCreateHtml = "Failed to create";
        u8g2.clearBuffer();
    ...
    resultCreateHtml = "index.html created";
    ...
    indexHtmlCreated = true; // Đặt cờ khi tạo file thành công
}
...
void setup() {
  ...
  // Chỉ tiến hành cấu hình WiFi nếu tạo file thành công
  if (indexHtmlCreated) {
    ...
    u8g2.drawStr(0, 22, "IP address:");
    String url = WiFi.localIP().toString();
    u8g2.drawStr(0, 33, url.c_str());
    u8g2.drawStr(0, 44, resultCreateHtml.c_str());
    u8g2.sendBuffer();
    ...
    ArduinoOTA.onProgress([](unsigned int progress, unsigned int total) {
      ...
      u8g2.clearBuffer();
      u8g2.setFont(u8g2_font_ncenB08_tr);
      u8g2.drawStr(0, 11, "Updating...");
      u8g2.drawStr(0, 22, ("Progress: " + String((progress / (total / 100))) + "%").c_str());
      u8g2.sendBuffer();
    });
    ...
    ArduinoOTA.onError([](ota_error_t error) {
      ...
      u8g2.clearBuffer();
      u8g2.setFont(u8g2_font_ncenB08_tr);
      u8g2.drawStr(0, 11, "OTA Error:");
      u8g2.drawStr(0, 22, errorMessage.c_str());
      u8g2.sendBuffer();
    });
  }
}
...
void loop() {
  ...
  if (WiFi.status() != WL_CONNECTED) {
    ...
    u8g2.clearBuffer();
    u8g2.setFont(u8g2_font_ncenB08_tr);
    u8g2.drawStr(0, 11, "WiFi disconnected");
    u8g2.drawStr(0, 22, "Reconnecting...");
    u8g2.sendBuffer();
    ...
    u8g2.clearBuffer();
    u8g2.setFont(u8g2_font_ncenB08_tr);
    u8g2.drawStr(0, 11, "WiFi reconnected");
    u8g2.drawStr(0, 22, "IP address:");
    u8g2.drawStr(0, 33, WiFi.localIP().toString().c_str());
    u8g2.drawStr(0, 44, resultCreateHtml.c_str());
    u8g2.sendBuffer();
  }
